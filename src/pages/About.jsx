    ...
    <div className="content-wrapper">
      <div className="edges" style={{ color: "#111", fontFamily: "Montserrat" }}>
        <div className="global-padding">
          ...
          <p>
            We seek gradual and consistent development of our members' skills and knowledge through weekly meetups and workshops, providing
            a stage for them to shine via project engagement, industry-sponsored events and hackathons. We also offer networking
            opportunities and social spaces for like-minded and aspiring students to communicate, collaborate and most importantly, build
            and share something awesome.
          </p>
          <p>
          ...
          <p>
            This site is a work in progress. If you'd like to contribute, you can do so{" "}
            <a href="https://github.com/codenetwork/viteCN">here</a>
          </p>
            ...
            {teamData.map((member, index) => (
              <div className="team-member" key={index}>
                ...
                <p className="personalLinks">
                  {member.link?.email && (
                    <a className="link" href={"mailto:" + member.link.email}>
                      <Email />
                    </a>
                  )}
                  {member.link?.linkedin && (
                    <a className="link" href={member.link.linkedin}>
                      <LinkedIn />
                    </a>
                  )}
                  {member.link?.github && (
                    <a className="link" href={member.link.github}>
                      <GitHub />
                    </a>
                  )}
                </p>
