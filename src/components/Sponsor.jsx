  ...
  return (
    <div id="global-padding">
      ...
      <div style={{ color: "white", fontSize: "18px", marginBottom: "8px" }}>
        Send us an email at{" "}
        <a href="mailto:industry@codenetwork.co" className="link">
          industry@codenetwork.co
        </a>
        .
      </div>
      <a className="btn btn-primary" href="/code_network_2024_prospectus.pdf" id="action" style={{ padding: "8px" }} target="_blank">
        Read Our Prospectus
      </a>
